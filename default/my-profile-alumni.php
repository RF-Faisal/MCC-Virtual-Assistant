                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarForms">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="forms-select2.html" class="nav-link" data-key="t-select2">Select2 <span class="badge badge-pill bg-danger" data-key="t-new">New</span></a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarTables">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="tables-datatables.html" class="nav-link" data-key="t-datatables">Datatables <span class="badge badge-pill bg-danger" data-key="t-new">New</span></a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                ...
                <div class="container-sm">
                    <div class="pb-lg-4">
                        <div class="row g-4">
                            <div class="col-auto">
                                <div class="avatar-lg">
                                    <img src="assets/images/users/avatar-3.jpg" alt="user-img" class="img-thumbnail rounded-circle" />
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col-auto">
                                                            ...
                                                            <table class="table table-borderless mb-0">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-muted">htzshmmr</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Full Name</th>
                                                                        <td class="text-muted">Ihtiaz Ishmam Rahman</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Email</th>
                                                                        <td class="text-muted">ishmamihtiaz@gmail.com</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Date of Birth</th>
                                                                        <td class="text-muted">25 Jun 1996</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Contact No</th>
                                                                        <td class="text-muted">01945954212</td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-muted">201514028</td>
                                                                    </tr>
                                                                    <tr>
                                                ...
                                                <div class="acitivity-timeline mt-3">
                                                    <div class="acitivity-item d-flex">
                                                        <div class="flex-shrink-0 avatar-sm acitivity-avatar">
                                                            <div class="flex-shrink-0">
                                                                <img src="assets/images/organizations/amazon.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h5 class="mb-1">Amazon</h5>
                                                            <h5 class="text-muted">Software Engineer</h5>
                                                            <h6 class="mb-4 text-muted">Nov 2020 - Present</h6>
                                                        </div>
                                                    </div>
                                                    <div class="acitivity-item d-flex">
                                                        <div class="flex-shrink-0 avatar-sm acitivity-avatar">
                                                            <div class="flex-shrink-0">
                                                                <img src="assets/images/organizations/codemarshal.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h5 class="mb-1">Codemarshal</h5>
                                                            <h5 class="text-muted">Software Engineer</h5>
                                                            <h6 class="mb-4 text-muted">Feb 2019 - Oct 2020</h6>
                                                        </div>
                                                    </div>
                                                    <div class="acitivity-item d-flex">
                                                        <div class="flex-shrink-0 avatar-sm acitivity-avatar">
                                                            <div class="flex-shrink-0">
                                                                <img src="assets/images/organizations/mcc.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h5 class="mb-1">MIST Computer Club</h5>
                                                            <h5 class="text-muted">President</h5>
                                                            <h6 class="mb-4 text-muted">Feb 2018 - Feb 2019</h6>
                                                        </div>
                                                    </div>
                                                    <div class="acitivity-item d-flex">
                                                        <div class="flex-shrink-0 avatar-sm acitivity-avatar">
                                                            <div class="flex-shrink-0">
                                                                <img src="assets/images/organizations/mukto.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h5 class="mb-1">Mukto Software Ltd.</h5>
                                                            <h5 class="text-muted">Software Engineer Intern</h5>
                                                            <h6 class="mb-4 text-muted">Nov 2017 - Jan 2018</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end row-->

<?php
    ...
    if(isset($_POST['addcourse']))
    {
        ...
        $sql = "INSERT INTO COURSE (COURSE_ID,COURSE_TITLE,CATEGORY,OVERVIEW,PRICE,START_TIME,DURATION) VALUES (CONCAT('C_',COURSE_ID_SEQ.NEXTVAL), '$coursetitle', '$category', '$overview', '$reqpoints', TO_DATE('$starttime','YYYY-MM-DD'), '$duration')";
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h2 class="mb-sm-0">Add Course</h2>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="coursetitle" id="courseTitleInput" placeholder="Course Title">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="category" id="categoryInput" placeholder="Category">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            <label for="priceInput" class="form-label">Required Points</label>
                                                            <input type="text" class="form-control" name="reqpoints" id="priceInput" placeholder="Required Points">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" class="form-control" name="starttime" id="timeInput" placeholder="Required Points">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="duration" id="durationInput" placeholder="Duration in Days">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            <label for="overviewInput" class="form-label">Overview</label>
                                                            <input type="text" class="form-control" name="overview" id="overviewInput" placeholder="Overview">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="hstack gap-2 justify-content-center mb-3">
                                                            <button class="btn btn-dark" type="addcourse" name="addcourse"><i class="mdi mdi-book-plus-outline"></i> Add Course</button>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                </div>

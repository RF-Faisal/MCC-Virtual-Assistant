<?php
    ...
    $sql = "select sum(reward_point) TOTAL from member";
    $stid = oci_parse($conn, $sql);
    oci_execute($stid);
    $sum_of_points = oci_fetch_array($stid, OCI_ASSOC + OCI_RETURN_NULLS);
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0"> Total Distributed Points</p>
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo $sum_of_points['TOTAL'];?>"></span></h4>
                                                        <a href="table-member.php?column=reward_point&order=desc" class="text-decoration-underline">View Full List</a>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <span class="avatar-title bg-soft-success rounded fs-3">
                                                            <i class="mdi mdi-alpha-p-circle-outline text-success"></i>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div><!-- end card body -->

! function(e, t) {
    ...
    const t = "SweetAlert2:",
        ...
        f = e => Object.prototype.hasOwnProperty.call(m, e),
        b = e => -1 !== o.indexOf(e),
        y = e => g[e],
        v = e => {
            !e.backdrop && e.allowOutsideClick && r('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`');
            for (const o in e) n = o, f(n) || r('Unknown parameter "'.concat(n, '"')), e.toast && (t = o, h.includes(t) && r('The parameter "'.concat(t, '" is incompatible with toasts'))), t = o, y(t) && c(t, y(t));
            var t, n
        };
    var e = e => {
        const t = {};
    ...
    const w = e(["container", "shown", "height-auto", "iosfix", "popup", "modal", "no-backdrop", "no-transition", "toast", "toast-shown", "show", "hide", "close", "title", "html-container", "actions", "confirm", "deny", "cancel", "default-outline", "footer", "icon", "icon-content", "image", "input", "file", "range", "select", "radio", "checkbox", "label", "textarea", "inputerror", "input-label", "validation-message", "progress-steps", "active-progress-step", "progress-step", "progress-step-line", "loader", "loading", "styled", "top", "top-start", "top-end", "top-left", "top-right", "center", "center-start", "center-end", "center-left", "center-right", "bottom", "bottom-start", "bottom-end", "bottom-left", "bottom-right", "grow-row", "grow-column", "grow-fullscreen", "rtl", "timer-progress-bar", "timer-progress-bar-container", "scrollbar-measure", "icon-success", "icon-warning", "icon-info", "icon-question", "icon-error"]),
    ...
    const D = () => A(".".concat(w.loader)),
        I = () => A(".".concat(w.actions, " .").concat(w.cancel)),
        H = () => P(w.actions),
        q = () => P(w.footer),
        V = () => P(w["timer-progress-bar"]),
        N = () => P(w.close),
        R = () => {
            const e = a(B().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort((e, t) => {
    ...
    const z = {
        ...
        Pe = (e, t) => {
            var n, o, i, a, r, s = H(),
                c = D();
            (t.showConfirmButton || t.showDenyButton || t.showCancelButton ? te : ne)(s), Y(s, t, "actions"), n = s, o = c, i = t, a = j(), r = M(), s = I(), Be(a, "confirm", i), Be(r, "deny", i), Be(s, "cancel", i),
                function(e, t, n, o) {
    ...
    const Te = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
        ...
        De = {};
    De.text = De.email = De.password = De.number = De.tel = De.url = (e, t) => ("string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : p(t.inputValue) || r('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')), je(e, e, t), Oe(e, t), e.type = t.input, e), De.file = (e, t) => (je(e, e, t), Oe(e, t), e), De.range = (e, t) => {
    ...
    const Ie = (e, t) => {
        ...
        _e = (e, o) => {
            ...
            te(i), i.textContent = "", o.currentProgressStep >= o.progressSteps.length && r("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), o.progressSteps.forEach((e, t) => {
                var n, e = (n = e, e = document.createElement("li"), $(e, w["progress-step"]), _(e, n), e);
                i.appendChild(e), t === o.currentProgressStep && $(e, w["active-progress-step"]), t !== o.progressSteps.length - 1 && (t = (e => {
        ...
        Ye = (e, t) => {
            var n = k();
            const o = B();
            t.toast ? (ee(n, "width", t.width), o.style.width = "100%", o.insertBefore(D(), x())) : ee(o, "width", t.width), ee(o, "padding", t.padding), t.color && (o.style.color = t.color), t.background && (o.style.background = t.background), ne(O()), ((e, t) => {
        ...
        Qe = e => {
            ...
            return a(e.querySelectorAll("swal-param")).forEach(e => {
                ...
                "boolean" == typeof m[t] && "false" === e && (n[t] = !1), "object" == typeof m[t] && (n[t] = JSON.parse(e))
            }), n
        },
        et = e => {
            const n = {};
    ...
    function ct(e) {
        var t, n;
        (t = e).inputValidator || Object.keys(st).forEach(e => {
            ...
            var t = he();
            if (le()) s("SweetAlert2 requires document to initialize");
            else {
    ...
    const ut = () => {
        ...
        pt = () => {
            var e;
            (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints) && !K(document.body, w.iosfix) && (e = document.body.scrollTop, document.body.style.top = "".concat(-1 * e, "px"), $(document.body, w.iosfix), (() => {
                const e = k();
                let t;
                e.ontouchstart = e => {
                    t = mt(e)
        ...
        Ct = (t, n) => {
            const o = B(),
                i = e => At[n.input](o, Pt(e), n);
            u(n.inputOptions) || p(n.inputOptions) ? (wt(j()), d(n.inputOptions).then(e => {
                t.hideLoading(), i(e)
            })) : "object" == typeof n.inputOptions ? i(n.inputOptions) : s("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(typeof n.inputOptions))
        },
        kt = (t, n) => {
            const o = t.getInput();
            ne(o), d(n.inputValue).then(e => {
        ...
        Pt = n => {
            ...
            return "undefined" != typeof Map && n instanceof Map ? n.forEach((e, t) => {
                let n = e;
                "object" == typeof n && (n = Pt(n)), o.push([t, n])
            }) : Object.keys(n).forEach(e => {
                let t = n[e];
                "object" == typeof t && (t = Pt(t)), o.push([e, t])
            }), o
        },
        ...
        xt = (e, t) => {
            ...
            n.inputValidator ? ((t, n, o) => {
                const e = Ee.innerParams.get(t);
                t.disableInput();
        ...
        Et = (t, n) => {
            const e = Ee.innerParams.get(t || void 0);
    ...
    const qt = (e, t, n) => {
        ...
        Rt = (e, t, n) => {
            var o, i, a = Ee.innerParams.get(e);
            a && (a.stopKeydownPropagation && t.stopPropagation(), "Enter" === t.key ? (o = e, i = a, (e = t).isComposing || e.target && o.getInput() && e.target.outerHTML === o.getInput().outerHTML && (["textarea", "file"].includes(i.input) || (Ht(), e.preventDefault()))) : "Tab" === t.key ? ((e, t) => {
                const n = e.target,
                    o = R();
                let i = -1;
    ...
    var Zt = Object.freeze({
        ...
        argsToParams: n => {
            const o = {};
            return "object" != typeof n[0] || Ut(n[0]) ? ["title", "html", "icon"].forEach((e, t) => {
                t = n[t];
                "string" == typeof t || Ut(t) ? o[e] = t : void 0 !== t && s("Unexpected type of ".concat(e, '! Expected "string" or "Element", got ').concat(typeof t))
            }) : Object.assign(o, n[0]), o
        },
        isVisible: () => ae(B()),
        clickConfirm: Ht,
        clickDeny: () => M() && M().click(),
        clickCancel: () => I() && I().click(),
        getContainer: k,
        getPopup: B,
        getTitle: E,
        getHtmlContainer: T,
    ...
    function Jt() {
        ...
        if (e) {
            ...
            ne(t.loader), U() ? e.icon && te(x()) : (e => {
                const t = e.popup.getElementsByClassName(e.loader.getAttribute("data-button-to-replace"));
                if (t.length) te(t[0], "inline-block");
                else if (re()) ne(e.actions)
            })(t), G([t.popup, t.actions], w.loading), t.popup.removeAttribute("aria-busy"), t.popup.removeAttribute("data-loading"), t.confirmButton.disabled = !1, t.denyButton.disabled = !1, t.cancelButton.disabled = !1
        }
    }
    var Xt = {
    ...
    function $t(e, t, n, o) {
        U() ? tn(e, o) : (me(n).then(() => tn(e, o)), de.keydownTarget.removeEventListener("keydown", de.keydownHandler, {
    ...
    const ln = (r, s, c) => new Promise((e, t) => {
            const n = e => {
                r.closePopup({
                    isDismissed: !0,
                    dismiss: e
            ...
            var o, i, a;
            Xt.swalPromiseResolve.set(r, e), Xt.swalPromiseReject.set(r, t), s.confirmButton.onclick = () => (e => {
                var t = Ee.innerParams.get(e);
                e.disableButtons(), t.input ? xt(e, "confirm") : Lt(e, !0)
            })(r), s.denyButton.onclick = () => (e => {
                var t = Ee.innerParams.get(e);
                e.disableButtons(), t.returnInputValueOnDeny ? xt(e, "deny") : Et(e, !1)
            })(r), s.cancelButton.onclick = () => ((e, t) => {
                e.disableButtons(), t(Je.cancel)
            })(r, n), s.closeButton.onclick = () => n(Je.close), o = r, e = s, t = n, Ee.innerParams.get(o).toast ? Ot(o, e, t) : (Mt(e), Dt(e), It(o, e, t)), i = r, e = de, t = c, a = n, e.keydownTarget && e.keydownHandlerAdded && (e.keydownTarget.removeEventListener("keydown", e.keydownHandler, {
                capture: e.keydownListenerCapture
            }), e.keydownHandlerAdded = !1), t.toast || (e.keydownHandler = e => Rt(i, e, a), e.keydownTarget = t.keydownListenerCapture ? window : B(), e.keydownListenerCapture = t.keydownListenerCapture, e.keydownTarget.addEventListener("keydown", e.keydownHandler, {
                capture: e.keydownListenerCapture
            }), e.keydownHandlerAdded = !0), t = r, "select" === (e = c).input || "radio" === e.input ? Ct(t, e) : ["text", "email", "number", "tel", "textarea"].includes(e.input) && (u(e.inputValue) || p(e.inputValue)) && (wt(j()), kt(t, e)), (e => {
                const t = k(),
                    n = B();
                ...
                vt(t, n, e), setTimeout(() => {
                    bt(t, n)
                }, ht), F() && (yt(t, e.scrollbarPadding, o), Xe()), U() || de.previousActiveElement || (de.previousActiveElement = document.activeElement), "function" == typeof e.didOpen && setTimeout(() => e.didOpen(n)), G(t, w["no-transition"])
            })(c), pn(de, c, n), mn(s, c), setTimeout(() => {
    ...
    Object.assign(cn.prototype, e), Object.assign(cn, Zt), Object.keys(e).forEach(e => {
        cn[e] = function() {

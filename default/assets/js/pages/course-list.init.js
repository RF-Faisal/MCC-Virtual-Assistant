...
var productListAll = new gridjs.Grid({
    columns: [{
        ...
        data: function(e) {
            return gridjs.html('<div class="d-flex align-items-center"><div class="flex-shrink-0 me-3"><div class="avatar-md bg-light rounded p-1"><img src="' + e.product.img + '" alt="" class="img-fluid d-block"></div></div><div class="flex-grow-1"><a href="apps-ecommerce-product-details.html" class="text-dark">' + e.product.title + '</a></div></div>')
        }
    }, {
...
document.querySelectorAll('a[data-bs-toggle="tab"]').forEach(function(e) {
    ...
    document.querySelectorAll(".checkbox-product-list input").forEach(function(e) {

document.getElementById("sa-basic") && document.getElementById("sa-basic").addEventListener("click", function() {
    ...
    Swal.fire({
        html: '<div class="mt-3"><lord-icon src="https://cdn.lordicon.com/gsqxdxog.json" trigger="loop" colors="primary:#f7b84b,secondary:#f06548" style="width:100px;height:100px"></lord-icon><div class="mt-4 pt-2 fs-15 mx-5"><h4>Are you sure?</h4><p class="text-muted mx-4 mb-0">Are you sure to delete this team?</p></div></div>',
        showCancelButton: !0,
        confirmButtonClass: "btn btn-danger w-xs me-2 mb-1",
        confirmButtonText: "Yes, Delete It!",
        cancelButtonClass: "btn btn-warning w-xs mb-1",
        buttonsStyling: !1,
        showCloseButton: !0
    })
